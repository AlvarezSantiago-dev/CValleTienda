-- P&L histórico: ganancia bruta y costo netos de devoluciones (excl. cambio de variante).
-- Alinea get_reporte_historico_meses con get_ganancia_bruta_mes a nivel línea.
...
COMMENT ON FUNCTION public.get_reporte_historico_meses(uuid, integer) IS
  'P&L mensual: ventas netas y ganancia bruta descontando devoluciones monetarias (reembolso/saldo a favor). Excluye cambio de variante.';
