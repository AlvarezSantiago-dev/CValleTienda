-- Caja: excluir devoluciones tipo cambio en totales de turno (preview y cierre).
...
-- cerrar_caja: mismo filtro en devoluciones del turno
...
COMMENT ON FUNCTION public.preview_resumen_turno(uuid) IS
  'Resumen de turno sin cerrar. Devoluciones monetarias (excl. cambio de variante).';
