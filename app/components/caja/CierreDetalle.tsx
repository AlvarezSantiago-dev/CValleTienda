  ...
  return (
    <div className="bg-white border border-gray-100 rounded-xl p-6 space-y-5">
      <div>
        ...
        <h2 className="text-base font-semibold text-[#0A0A0A] mt-2">
      ...
      <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
        <h3 className="text-[10px] uppercase tracking-[0.10em] font-semibold text-gray-400 mb-2">Arqueo de efectivo</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
          ...
          <div className="rounded-lg border border-gray-200 bg-white px-3 py-2">
            ...
            <p className={`text-base font-semibold ${difTone}`}>
      ...
      <div>
        <h3 className="text-[10px] uppercase tracking-[0.10em] font-semibold text-gray-400 mb-2">Desglose por cuenta</h3>
        {cierre.detalles.length === 0 ? (
          <p className="text-sm text-gray-500 italic">No hubo movimientos en este turno.</p>
        ) : (
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                {cierre.detalles.map((d) => (
                  <tr key={d.id}>
                    <td className="px-3 py-2 font-medium text-gray-900">{d.nombre_cuenta}</td>
                    <td className="px-3 py-2 text-gray-600">{d.tipo_cuenta}</td>
