...
export function CerrarSesionForm({ sesion }: CerrarSesionFormProps) {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="bg-white border border-gray-100 rounded-xl p-6 max-w-xl space-y-4"
    >
      <div>
        <h2 className="text-base font-semibold text-[#0A0A0A]">Cerrar caja</h2>
      ...
      <div className="rounded-lg bg-amber-50 border border-amber-200 p-3 text-sm text-amber-900">
        ...
        <p className="text-base font-semibold">{formatARS(saldoEfectivo)}</p>
